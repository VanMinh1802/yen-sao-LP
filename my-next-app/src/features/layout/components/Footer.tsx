...
import { fadeIn, fadeInUp, luxuryEase } from "@/lib/motion";
    ...
    <footer className="bg-brown-900 text-white-70 pt-16 pb-8 border-t border-white-10">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1.5fr] gap-12 lg:gap-8 xl:gap-12 mb-16">
          {/* Col 1 */}
          <motion.div custom={0} variants={footerColumnVariant} className="flex flex-col space-y-6">
          ...
          {/* Col 2 */}
          <motion.div custom={1} variants={footerColumnVariant} className="flex flex-col space-y-6">
          ...
          {/* Col 3 */}
          <motion.div custom={2} variants={footerColumnVariant} className="flex flex-col space-y-6">
            <h3 className="text-gold-400 text-base uppercase tracking-[1px] font-bold">
              Sản Phẩm
            </h3>
            <ul className="flex flex-col space-y-3">
          ...
          {/* Col 4 */}
          <motion.div custom={3} variants={footerColumnVariant} className="flex flex-col space-y-6">
            <h3 className="text-gold-400 text-base uppercase tracking-[1px] font-bold">
              Liên Hệ
            </h3>
