...
- **sdlc:systematic-debugging** — Use debugging first to identify root causes,
  then dispatch parallel agents for independent fixes
- **sdlc:verification-before-completion** — Verify all fixes work together after
  agents return
