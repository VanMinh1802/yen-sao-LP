...
6. **Write design doc** — save to `.sdlc/SPEC<NNN>-<module>-<kebab-case-title>/spec.md` and commit
...
- Use `sdlc:using-git-worktrees` to create an isolated workspace before proceeding (if not yet done)
